...
} from "./kobun-logic.js?v=2026.9.37";
import { mergeAttempt, summarizeProgressGauge } from "./logic.js?v=2026.9.37";
import { getMetaObject, putHistory, setMeta, stashMeta } from "./storage.js?v=2026.9.37";
  ...
  async function load() {
    if (!loading) loading = (async () => {
      const [auxResponse, vocabResponse, progress] = await Promise.all([
        fetch("./data/kobun-auxiliaries.json?v=2026.9.37"),
