...
test("PWA cache ships every versioned MAX effect asset", () => {
  assert.match(indexHtml, /styles\.css\?v=2026\.2\.17/);
  assert.match(indexHtml, /src\/app\.js\?v=2026\.2\.17/);
  assert.match(serviceWorker, /words-2026-2-v17/);
  assert.match(serviceWorker, /src\/audio\.js\?v=2026\.2\.17/);
  assert.match(serviceWorker, /src\/max-cues\.js\?v=2026\.2\.17/);
});
